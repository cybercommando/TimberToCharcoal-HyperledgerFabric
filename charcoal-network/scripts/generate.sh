...
../bin/configtxgen -configPath ./charcoal-network -profile AuditOrdererGenesis -outputBlock ./charcoal-network/channel-artifacts/genesis.block -channelID mychannel
