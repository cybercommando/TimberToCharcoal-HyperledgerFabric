...
>If someone improve or enhance the code and needs to generate updated version of autogenerated documentation kindly run the following command in root folder to generate documentation.
